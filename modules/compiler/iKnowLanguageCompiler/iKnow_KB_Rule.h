...
namespace iknow {
	namespace csvdata {
		...
		public:
			...
			std::string TransformRulePattern(std::string& csv_rule_input, std::string& csv_phase, CSV_DataGenerator& kb, newLabels_type &newLabels, newLabelsIndex_type &newLabelsIndex, AutoGeneratedLabels_type&);
