...
PYVERSIONS_MACOSUNIVERSAL="3.8.10 3.9.13 3.10.11 3.11.3"
PYURLS_MACOSUNIVERSAL="https://www.python.org/ftp/python/3.8.10/python-3.8.10-macos11.pkg https://www.python.org/ftp/python/3.9.13/python-3.9.13-macos11.pkg https://www.python.org/ftp/python/3.10.11/python-3.10.11-macos11.pkg https://www.python.org/ftp/python/3.11.3/python-3.11.3-macos11.pkg"
CCACHE_VERSION=4.8.1
CCACHE_URL=https://github.com/ccache/ccache/releases/download/v4.8.1/ccache-4.8.1-windows-x86_64.zip
CYTHON_VERSION=0.29.35
MANYLINUX2014_X86_64_TAG=2023-06-04-afc7a6d
MANYLINUX2014_AARCH64_TAG=2023-06-04-afc7a6d
MANYLINUX2014_PPC64LE_TAG=2023-06-04-afc7a6d
