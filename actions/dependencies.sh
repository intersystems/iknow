...
PYVERSIONS_OSX="3.6.15 3.7.14 3.8.14 3.9.14 3.10.7 3.11.0"
...
BUILDCACHE_NAME="Release v0.28.1"
BUILDCACHE_URL_WIN=https://github.com/mbitsnbites/buildcache/releases/download/v0.28.1/buildcache-windows.zip
CYTHON_VERSION=0.29.32
MANYLINUX2014_X86_64_TAG=2022-10-30-402504a
MANYLINUX2014_AARCH64_TAG=2022-10-30-402504a
MANYLINUX2014_PPC64LE_TAG=2022-10-30-402504a
