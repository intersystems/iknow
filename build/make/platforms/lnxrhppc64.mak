...
OBJECTSUFFIX = .o
LIBFLAGS = -fPIC
OBJECTFLAGS += -c -O2 -DMY_BIG_ENDIAN=1 -D_ISC_BIGENDIAN=1 -DBIT64PLAT -DSIZEOF_LONG=8 -Wno-non-template-friend -DLINUX -DUNIX $(if $(CREATELIBRARY),$(LIBFLAGS))
...
PLAT_OPENSSL_CONFIGURE_OPTIONS = linux-ppc64
PLAT_CMQL_CONFIGURE_OPTIONS = --enable-64bit
PLAT_ANTLR_CONFIGURE_OPTIONS = --enable-64bit
PLATSOEXT=so
PLAT_MQ_LIBRARIES = imqc23gl imqb23gl mqic
...
PLAT_ZLIB_OBJECTFLAGS = -c -O3 -DBIT64PLAT -DSIZEOF_LONG=8 -DLINUX -DUNIX $(if $(CREATELIBRARY),$(LIBFLAGS))
